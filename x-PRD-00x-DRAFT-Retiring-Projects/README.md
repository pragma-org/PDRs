...
This PDR describes removing a project from PRAGMA, marking it as inactive, or archiving it.
...
Archive projects are read-only, do not need to be reported, and will be labeled as archived
in the GitHub repository. Archived projects will not be deleted but made accessible
for future generations.

PRAGMA Incubating Projects can have the state of "rejected," equivalent
...
was not accepted by the board and was never part of PRAGMA.

### Trademarks

If a project is archived or rejected, no trademarks will be transferred to any third party. 

### Archiving a project

If a project is unresponsive to the board or no significant activity
